        ...
        <div className="flex-1 bg-gradient-to-br from-blue-50 to-blue-100 p-6 rounded-xl shadow-sm border border-blue-200">
          <div className="flex flex-col items-center text-center">
            ...
            <h2 className="text-2xl font-bold text-blue-800">
              {userData.calorieGoal.toLocaleString()} kcal
            </h2>
            ...
            <div className="w-full flex items-center gap-3 mt-2">
              ...
              <Slider
                ...
                step={50}
                onValueChange={(value) =>
                  setUserData({ ...userData, calorieGoal: value[0] })
                }
                className="flex-1"
              />
          ...
          <div className="grid grid-cols-3 gap-4 mt-6">
            <div className="flex flex-col items-center p-3 bg-white rounded-lg shadow-sm">
              ...
              <span className="text-xs text-gray-500">
                {Math.round(
                  (userData.calorieGoal * (userData.macros.carbs / 100)) / 4
                )}
                g
              </span>
            </div>
            ...
            <div className="flex flex-col items-center p-3 bg-white rounded-lg shadow-sm">
              ...
              <span className="text-xs text-gray-500">
                {Math.round(
                  (userData.calorieGoal * (userData.macros.protein / 100)) / 4
                )}
                g
              </span>
            </div>
            ...
            <div className="flex flex-col items-center p-3 bg-white rounded-lg shadow-sm">
              ...
              <span className="text-xs text-gray-500">
                {Math.round(
                  (userData.calorieGoal * (userData.macros.fat / 100)) / 9
                )}
                g
              </span>
            </div>
          ...
          {isEditing && (
            <Button
              ...
              onClick={() =>
                setActiveTab(activeTab === "manual" ? "calculator" : "manual")
              }
            >
              {activeTab === "manual" ? (
                <>
        ...
        <div className="flex justify-between items-center mb-4">
          <div>
            ...
            <p className="text-sm text-gray-500">
              Balance your nutrients for optimal results
            </p>
          </div>
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent>
                <p className="text-xs max-w-xs">
                  Macronutrients total 100%. Carbs and protein provide 4
                  calories per gram, while fat provides 9 calories per gram.
                </p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
                ...
                <div className="grid grid-cols-1 md:grid-cols-5 gap-2">
                  {[
                    ...
                    },
                    {
                      value: "light",
                      label: "Light",
                      description: "Exercise 1-2 times/week",
                    },
                    {
                      value: "moderate",
                      label: "Moderate",
                    ...
                    <div
                      ...
                      onClick={() =>
                        ...
                        setUserData({
                          ...userData,
                          activityLevel: activity.value as
                            | "sedentary"
                            | "light"
                            | "moderate"
                            | "active"
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                  <div
                    ...
                    onClick={() =>
                      isEditing &&
                      setUserData({ ...userData, goal: "lose_weight" })
                    }
                  >
                  ...
                  <div
                    ...
                    onClick={() =>
                      isEditing &&
                      setUserData({ ...userData, goal: "maintain" })
                    }
                  >
                    <div className="flex items-center justify-center mb-2">
                  ...
                  <div
                    ...
                    onClick={() =>
                      isEditing &&
                      setUserData({ ...userData, goal: "gain_weight" })
                    }
                  >
                    <div className="flex items-center justify-center mb-2">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          <div>
            ...
            <p className="text-blue-100">
              We'll generate meals that match your calorie and macro goals
            </p>
          </div>
          <Button
            variant="secondary"
