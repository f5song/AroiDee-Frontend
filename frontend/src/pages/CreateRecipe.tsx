...
export default function CreateRecipePage() {
  ...
  const [selectedCategory] = React.useState<string>("");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        updateBasicInfo(
          "submit" as any,
          result.error || "Failed to save recipe"
        );
      }
    } catch (error) {
                ...
                <CardContent className="space-y-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          ...
                          {errors.cookingTime && (
                            <p className="text-red-500 text-sm mt-1">
                              {formatErrorMessage(errors.cookingTime)}
                            </p>
                          )}
                        </div>
                        ...
                        <div>
                          ...
                          <div className="flex items-center mt-2">
                            ...
                            <Slider
                              ...
                              step={10}
                              onValueChange={(value) =>
                                updateBasicInfo("calories", value[0])
                              }
                              className={`${
                          ...
                          {errors.calories && (
                            <p className="text-red-500 text-sm mt-1">
                              {formatErrorMessage(errors.calories)}
                            </p>
                          )}
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div>
                            <Select
                              value={selectedCategory || "default"} // ✅ ใช้ค่าเริ่มต้นที่ไม่เป็น empty string
                              onValueChange={(value) =>
                                value !== "default" &&
                    ...
                    <div>
                      ...
                      {errors.ingredients && (
                        <p className="text-red-500 text-sm mb-2">
                          {formatErrorMessage(errors.ingredients)}
                        </p>
                      )}
                  ...
                  >
                    <div>
                      ...
                      {errors.instructions && (
                        <p className="text-red-500 text-sm mb-2">
                          {formatErrorMessage(errors.instructions)}
                        </p>
                      )}
                              ...
                              <div className="flex justify-between mt-1">
                                <div className="flex gap-1">
                                  <Button
                                    ...
                                    size="sm"
                                    onClick={() =>
                                      moveInstruction(instruction.id, "up")
                                    }
                                    disabled={index === 0}
                                  ...
                                  <Button
                                    ...
                                    size="sm"
                                    onClick={() =>
                                      moveInstruction(instruction.id, "down")
                                    }
                                    disabled={
                                    ...
                                    className="h-6 px-2 text-xs"
                                  >
                                    <ArrowDown className="h-3 w-3 mr-1" /> Move
                                    Down
                                  </Button>
                                </div>
                                <Button
